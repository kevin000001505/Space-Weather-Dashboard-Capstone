...
export const SUPERVISORS = [
  {
    ...
    description: "Assistant Director, MS Data Analytics Engineering Program at George Mason University",
    image:
      "/about/prof_bernard_schmidt.jpg",
    gmu: "https://cec.gmu.edu/profiles/bschmid5",
    linkedin: "https://www.linkedin.com/in/bernard-schmidt-75302ab/",
  },
  {
    id: 2,
    name: "Prof. Edward J. Oughton",
    title: "Project Supervisor",
    description: "My research focuses on the modeling and simulation of critical infrastructure, particularly telecoms, energy, and transportation networks. This involves expertise in spatial computing, risk analysis, GeoAI, remote sensing, image processing, natural hazards, and public policy. I also have a teaching portfolio which includes satellite image processing, GeoAI, and spatial computing. Please see my Google Scholar for current research outputs.",
    image:
      "/about/prof_edward_oughton.jpg",
    gmu: "https://science.gmu.edu/directory/edward-oughton",
    scholar: "https://scholar.google.com/citations?user=ZsyYn4cAAAAJ&hl=en",    
    linkedin: "https://www.linkedin.com/in/edwardoughton/",
  },
  {
    id: 3,
    name: "Prof. Lance Sherry",
    title: "Project Supervisor",
    description: "Professor, Director at Center for Air Transportation Systems Research; Department of Systems Engineering and Operations Research",
    image:
      "/about/prof_lance_sherry.avif",
    gmu: "https://mechanical.gmu.edu/profiles/lsherry",
    scholar: "https://scholar.google.com/citations?user=vYuc5OYAAAAJ&hl=en",
