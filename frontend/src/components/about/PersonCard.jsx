...
import { CARD_FLIP_DURATION_MS, CARD_STAGGER_DELAY_MS, CARD_SUPERVISOR_HEIGHT, CARD_DEVELOPER_HEIGHT } from "./constants";
      ...
      >
        ...
        >
          <Box sx={{
            ...
            boxShadow: "0 0 16px rgba(0,200,180,0.22), inset 0 0 10px rgba(0,0,0,0.5)",
            background: "#0a1a2e",
          }}>
            <Box
              component="img"
          ...
          <Box sx={{ minWidth: 0, flex: 1 }}>
            ...
            <Box sx={{
              width: "2rem",
              height: "1.5px",
              background: "linear-gradient(to right, rgba(0,200,180,0.7), transparent)",
              mb: "0.375rem",
              borderRadius: "1px",
            }} />
            ...
            <Box sx={{
              ...
              <Box
                ...
                sx={{ width: "100%", height: "100%", objectFit: "cover",
                      display: "block", filter: "saturate(0.85) brightness(0.88)" }}
              />
            </Box>
            <Typography sx={{
